...
<body>
    <div class="container">
        <h1>Exclusão de Filmes Cadastrados</h1>
    ...
    <div class="container">
        <?php
            ...
            require_once("./exc-filme-view.php");
        ?>

        <form action="exc-filmebd.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row-flex">
                <div class="col centralizar-h"  style="margin-top: 35px;">
                    ...
                    <input type="submit" style="background-color: red" value="EXCLUIR">
                </div>
            </div>
        </form>
    </div>
